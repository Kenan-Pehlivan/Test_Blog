<!-- Veränderungsdatum: 08.10.2024 
      Das Anklicken der Posts auf der Homepage soll zum richtigen Post mit TopicID und PostID führen. Außerdem werden in der rechten Seitenleiste
      weitere angelegte Posts angezeigt.  
-->

<?php
include("path.php");
include(ROOT_PATH . '/app/controllers/posts.php');
require(ROOT_PATH . '/app/controllers/comments.php');

//Auswahl eines bestimmten Posts aus der Datenbanktabelle mittels selectOne und den übergebenen Parametern aus der DB
if (isset($_GET['id'])) {
    $post = selectOne('posts', ['id' => $_GET['id']]);
}

// Ansonsten zeige alle Posts und Topics die gepublished sind
